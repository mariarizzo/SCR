    ...
    ###       ISBN 9781584885450                        ###
    ###                                                 ###
    ###       R code for Chapter 10 Examples            ###
    #######################################################
...
### Example 10.8 (KDE of precipitation data)
...
### Example 10.9 (Computing $\hat f(x)$ for arbitrary x)
...
### Example 10.15 (Product kernel estimate of a BVN mixture)
...
### Code to plot the histograms in Figure 10.4
...
### Code to plot kernels in Figure 10.7
